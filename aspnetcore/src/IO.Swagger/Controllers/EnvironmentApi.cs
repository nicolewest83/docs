...
{ 
    ...
    { 
        ...
        [HttpGet]
        [Route("/nicolewest83/Hubb/1.0.0/temperature/forecast/{days}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/nicolewest83/Hubb/1.0.0/temperature/{zoneId}/heater")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/nicolewest83/Hubb/1.0.0/temperature/{zoneId}")]
        [ValidateModelState]
        ...
        [HttpPost]
        [Route("/nicolewest83/Hubb/1.0.0/temperature/{zoneId}/heater/{state}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/nicolewest83/Hubb/1.0.0/temperature")]
        [ValidateModelState]
